...
namespace DealerManagementSystem
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-F1O9AIB;Initial Catalog=dms;Integrated Security=True;");
        ...
        private void txtPDes_TextChanged(object sender, EventArgs e)
        {
